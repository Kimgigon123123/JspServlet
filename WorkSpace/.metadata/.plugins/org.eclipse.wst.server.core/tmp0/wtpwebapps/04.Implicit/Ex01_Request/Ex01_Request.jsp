...
<body>
	...
	<!-- 
		...
		Java (Controller) : 눈에 안보이지만 View에서 들어온 요청을 처리하는 부분 .
							(Java,C++,C#,Python,Servlet ... 등의 백앤드 언어)
							
		request(Model) : View 와 Controller 사이에서 데이터를 전송하는 목적으로 사용하는 객체. (사용하는 로직)
		MVC 패턴 - Web에서 가장 흔히 그리고 널리 사용되는 디자인 패턴 ( V -> C-> M -> V -> C -> ...)
		
		 -->
		 
		 <!--  GET 방식으로 Servlet요청해보기, POST방식으로 Servlet에 요청해보기
		 		요청받을 맵핑 => Ex01_Request <=
		 		// localhost/imp/Ex01_Request =>Servlet 파일이 동작
